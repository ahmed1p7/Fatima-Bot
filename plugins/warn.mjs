// ═══════════════════════════════════════════════════════════════════════════════
// 🛡️ نظام الإنذارات والإدارة - فاطمة بوت v11.0
// ═══════════════════════════════════════════════════════════════════════════════
...
export default {
  name: 'Warning',
  commands: ['إنذار', 'انذار', 'warn', 'تحذير'],
...
export const warnings = {
  name: 'Warnings',
  commands: ['إنذارات', 'انذارات', 'warnings', 'الإنذارات'],

  async execute(sock, msg, ctx) {
    const { from, isGroup, isGroupAdmin, isOwner } = ctx;
...
export const pardon = {
  name: 'Pardon',
  commands: ['عفو', 'pardon', 'مسح_إنذار', 'صفح'],

  async execute(sock, msg, ctx) {
    const { from, isGroup, isGroupAdmin, isOwner, args, quoted } = ctx;
...
export const mention = {
  name: 'Mention',
  commands: ['منشن', 'mention', 'الجميع', 'everyone', 'هيت'],

  async execute(sock, msg, ctx) {
    const { from, isGroup, isGroupAdmin, isOwner, args, text } = ctx;
...
export const hiddenMention = {
  name: 'HiddenMention',
  commands: ['مخفي', 'hidden', 'منشن_مخفي', 'هيدن'],

  async execute(sock, msg, ctx) {
    const { from, isGroup, isGroupAdmin, isOwner, args } = ctx;
