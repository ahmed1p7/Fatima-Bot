...
// بدء تحدي
export const challengeClan = (challengerId, targetId, challengerLeader) => {
  const data = getRpgData();
...
// قبول التحدي
export const acceptChallenge = (challengeId, targetLeader) => {
...
// رفض التحدي
export const rejectChallenge = (challengeId) => {
  return pendingChallenges.delete(challengeId);
};
