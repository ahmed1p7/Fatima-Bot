// ═══════════════════════════════════════════════════════════════════════════════
// 🖼️ نظام إرسال الصور - فاطمة بوت v11.0
...
// الصورة الافتراضية
const DEFAULT_IMAGE_URL = 'https://s3.ezgif.com/tmp/ezgif-3ef34f0636e9f2e5.jpg';
...
export const sendImageFromUrl = async (sock, jid, imageUrl, caption = '', options = {}) => {
  try {
    ...
    const message = {
      image: buffer,
      caption: caption,
      jpegThumbnail: buffer, // صورة مصغرة للمعاينة
      mimetype: 'image/jpeg',
      ...options
    };
